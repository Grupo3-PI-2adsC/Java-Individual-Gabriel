...
// import org.example.models.Registro;
...
public class LimparVolume {
    ...
    Path pastaTemp = !looca.getSistema().getSistemaOperacional().contains("Linux") ? Paths.get("C:\\Users\\GabrielOliveira\\Documents\\LimparVolume") : Paths.get("/var/tmp");
